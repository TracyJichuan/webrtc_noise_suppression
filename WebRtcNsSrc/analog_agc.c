...
int MD_WebRtcAgc_Process(void *agcInst, const int16_t *in_near,
...
int MD_WebRtcAgc_set_config(void *agcInst, WebRtcAgc_config_t agcConfig)
{
    Agc_t *stt;
    stt = (Agc_t *)agcInst;
...
int MD_WebRtcAgc_Create(void **agcInst)
{
    Agc_t *stt;
    if (agcInst == NULL)
    {
 ...
 */
int MD_WebRtcAgc_Init(void *agcInst, int32_t minLevel, int32_t maxLevel,
                   int16_t agcMode, uint32_t fs)
{
    ...
    if (MD_WebRtcAgc_set_config(stt, stt->defaultConfig) == -1)
    {
